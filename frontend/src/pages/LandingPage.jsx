...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#122C4F] via-[#1a3a5f] to-[#122C4F]">
      {/* Navigation */}
      ...
      <section className="relative pt-32 pb-20 px-4 overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          ...
          <div className="absolute bottom-20 right-10 w-96 h-96 bg-[#5B88B2] rounded-full blur-3xl"></div>
        </div>
      ...
      <section id="history" className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16 animate-fadeIn">
            ...
            <div className="w-24 h-1 bg-gradient-to-r from-[#FFC20A] to-[#FF8C00] mx-auto mb-6"></div>
            <p className="text-[#FBF9E3]/70 text-lg">From inception to intercollegiate excellence</p>
          </div>
      ...
      {/* Footer */}
      <footer className="bg-[#0a1929] py-12 px-4 border-t border-[#FFC20A]/20">
        <div className="max-w-7xl mx-auto text-center">
          <div className="flex items-center justify-center space-x-3 mb-6">
            <div className="w-10 h-10 bg-gradient-to-br from-[#FFC20A] to-[#FF8C00] rounded-lg flex items-center justify-center font-bold text-[#122C4F] text-lg">
              B
            </div>
            <div>
