          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div className="flex-1 relative">
              ...
              <Input
                ...
                className="pl-10 bg-white/10 border-[#FFC20A]/30 text-white placeholder:text-white/40"
            ...
            <div className="flex items-center space-x-4">
              <select
                ...
                className="bg-white/10 border border-[#FFC20A]/30 text-white rounded-md px-4 py-2"
              ...
              <Button
                onClick={exportToCSV}
                className="bg-gradient-to-r from-[#FFC20A] to-[#FF8C00] text-[#122C4F] font-bold"
              ...
              return (
                ...
                <div className="mt-4 pt-4 border-t border-white/10">
                  <details className="cursor-pointer">
                    <summary className="text-[#FFC20A] font-medium hover:text-[#FF8C00] transition-colors">
                      View Team Details
                    </summary>
                        ...
                        <div key={teamIdx} className="bg-white/5 rounded-lg p-4">
                          ...
                          <div className="grid md:grid-cols-2 gap-2 text-sm text-[#FBF9E3]/70">
                            {team.members.map((member, memberIdx) => (
                              <div key={memberIdx}>
                                <span className="text-[#FFC20A]">#{memberIdx + 1}</span> {member.name}
