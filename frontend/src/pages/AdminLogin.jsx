    ...
    <div className="min-h-screen bg-[#122C4F] flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <Button
          variant="ghost"
          onClick={() => navigate('/')}
          className="text-[#FBF9E3] hover:text-[#5B88B2] mb-6"
        ...
        <Card className="bg-gradient-to-br from-[#1a1a1a] to-black border-[#5B88B2]/40 p-8">
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <Button
              type="submit"
              disabled={loading}
              className="w-full bg-gradient-to-r from-[#5B88B2] to-[#6F9BC2] text-[#122C4F] font-bold text-lg py-6 hover:shadow-xl hover:shadow-[#5B88B2]/30 transition-all"
